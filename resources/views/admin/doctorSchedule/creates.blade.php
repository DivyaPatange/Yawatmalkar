...
@endsection
@section('page_title', 'Add Doctor Schedule Data')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.doctor-schedule.create') }}">Add Doctor Schedule Data</a>
@endsection
@section('content')
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Add Doctor Schedule Data</h5>
            </div>
            <div class="card-body">
                <form method="POST" id="form-submit" action="{{ route('admin.doctor-schedule.store') }}">
                @csrf
                    <div class="row">
                        <div class="col-md-6">
