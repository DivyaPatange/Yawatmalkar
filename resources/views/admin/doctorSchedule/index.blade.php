...
@endsection
@section('page_title', 'Doctor Schedule Management')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.doctor-schedule.index') }}">Doctor Schedule Management</a>
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Doctor Schedule List</h5>
                <a href="{{ route('admin.doctor-schedule.create') }}"><button type="button" class="btn btn-outline-primary float-right" title="" style="padding:10px 20px">Add New</button></a>
            </div>
            <div class="card-body">
