...
<div class="row" id="firstStep">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" id="form-submit" action="{{ route('admin.doctors.update', $user->id) }}">
                @csrf 
                @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="doctor_name" class="form-control" id="doctor_name" placeholder="Enter Doctor Name" value="{{ $user->name }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
