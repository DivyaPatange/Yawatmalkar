...
@endsection
@section('page_title', 'Lawyer Schedule Management')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.lawyer-schedule.index') }}">Lawyer Schedule Management</a>
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Lawyer Schedule List</h5>
                <a href="{{ route('admin.lawyer-schedule.create') }}"><button type="button" class="btn btn-outline-primary float-right" title="" style="padding:10px 20px">Add New</button></a>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Edit Lawyer Schedule</h4>
...
var SITEURL = '{{ route('admin.lawyer-schedule.index')}}';
function format ( d ) {
...
function EditModel(obj,bid)
{
    ...
    $.ajax({
        type:"POST",
        url:"{{ route('admin.get.lawyer-schedule') }}",
        data:datastring,
        cache:false,        
...
function checkSubmit()
{
    ...
    { 
        ...
        $.ajax({
            type:"POST",
            url:"{{ url('/admin/lawyer-schedule/update') }}",
...
$('body').on('click', '#delete', function () {
    ...
    if(confirm("Are You sure want to delete !")){
        $.ajax({
            type: "delete",
            url: "{{ url('admin/lawyer-schedule') }}"+'/'+id,
...
$('body').on('click', '.switch_1', function () {
    ...
    if(id != ''){
        $.ajax({
            type: "get",
            url: "{{ url('admin/lawyer-schedule/status') }}"+'/'+id,
            success: function (data) {
                // alert(data.teacher);
            var oTable = $('#zero_config').dataTable(); 
            oTable.fnDraw(false);
