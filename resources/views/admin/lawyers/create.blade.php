                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="lawyer_name" class="form-control" id="lawyer_name" placeholder="Enter Lawyer Name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
            ...
            <div class="card-body">
                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <input type="hidden" name="lawyer_id" id="lawyer_id" value="">
            ...
            <div class="card-body">
                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <input type="hidden" name="lawyer_id" id="lawyer_id1" value="">
...
$('body').on('click', '#submitForm', function () {
    ...
    { 
        $.ajax({
            type:"POST",
            url:"{{ route('admin.lawyers.store') }}",
            data:{lawyer_name:lawyer_name, category_id:category_id, sub_category_id:sub_category_id, contact_no:contact_no, alt_contact_no:alt_contact_no, aadhar_no:aadhar_no, email:email, experience:experience, qualification:qualification, specialization:specialization, office_addr:office_addr, residential_addr:residential_addr, working_hour:working_hour, other_profession:other_profession, dob:dob, expectation:expectation, achievement:achievement, urself:urself, username:username, password:password, Data:Data},
            cache:false,        
...
$('body').on('submit', '#form-submit1', function (event) {
    ...
    if(file_size>300000) {
        ...
        $.ajax({
            url   :"{{ route('admin.lawyer.upload-document') }}",
            type  :"POST",
            data  :formdata,
            cache :false,
            processData: false,
...
$('body').on('submit', '#form-submit2', function (event) {
    ...
    if (mou_sign) {
        ...
        $.ajax({
            url   :"{{ route('admin.lawyer.general-info') }}",
            type  :"POST",
            data  :formdata,
            cache :false,
            processData: false,
