...
@endsection
@section('page_title', 'Add Beautician Schedule Data')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.beautician-schedule.create') }}">Add Beautician Schedule Data</a>
@endsection
@section('content')
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Add Beautician Schedule Data</h5>
            </div>
            <div class="card-body">
                <form method="POST" id="form-submit" action="{{ route('admin.beautician-schedule.store') }}">
                @csrf
                    <div class="row">
                        <div class="col-md-6">
