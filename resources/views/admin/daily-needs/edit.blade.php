...
@endsection
@section('page_title', 'Edit Service Provider')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.daily-needs.edit', $user->id) }}">Edit Service Provider</a>
@endsection
@section('content')
<div class="row" id="firstStep">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" id="form-submit" action="{{ route('admin.daily-needs.update', $user->id) }}">
                @csrf 
                @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="provider_name" class="form-control" id="provider_name" placeholder="Enter Service Provider Name" value="{{ $user->name }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
