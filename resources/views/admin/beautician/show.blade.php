...
@endsection
@section('page_title', 'Beautician Profile')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.beautician.show', $user->id) }}">Beautician Profile</a>
@endsection
@section('content')
<div class="row">
    <div class="col-sm-12">
        <h5 class="mt-4">Beautician Profile</h5>
        <hr>
    </div>
    <?php 
