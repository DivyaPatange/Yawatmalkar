...
@endsection
@section('page_title', 'Edit Beautician')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.beautician.edit', $user->id) }}">Edit Beautician</a>
@endsection
@section('content')
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Edit Beautician</h5>
            </div>
            <div class="card-body">
                <form method="POST" id="form-submit" action="{{ route('admin.beautician.update', $user->id) }}">
                @csrf 
                @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="beauty_name" class="form-control" id="beauty_name" placeholder="Enter Beautician Name" value="{{ $user->name }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
