...
@endsection
@section('page_title', 'Add Beautician')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.beautician.create') }}">Add Beautician</a>
@endsection
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Name of Beautician <span style="color:red;">*</span><span  style="color:red" id="beauty_err"> </span></label>
                                <input type="text" name="beauty_name" class="form-control" id="beauty_name" placeholder="Enter Beautician Name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
            ...
            <div class="card-body">
                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <input type="hidden" name="beauty_id" id="beauty_id" value="">
            ...
            <div class="card-body">
                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <input type="hidden" name="beauty_id" id="beauty_id1" value="">
...
$('body').on('click', '#submitForm', function () {
    var beauty_name = $("#beauty_name").val();
    ...
    if (beauty_name=="") {
        $("#beauty_err").fadeIn().html("Required");
        setTimeout(function(){ $("#beauty_err").fadeOut(); }, 3000);
        $("#beauty_name").focus();
        return false;
    }
    if (experience=="") {
    ...
    { 
        $.ajax({
            type:"POST",
            url:"{{ route('admin.beautician.store') }}",
            data:{beauty_name:beauty_name, category_id:category_id, sub_category_id:sub_category_id, contact_no:contact_no, alt_contact_no:alt_contact_no, aadhar_no:aadhar_no, email:email, experience:experience, qualification:qualification, specialization:specialization, office_addr:office_addr, residential_addr:residential_addr, working_hour:working_hour, other_profession:other_profession, dob:dob, expectation:expectation, achievement:achievement, urself:urself, username:username, password:password, Data:Data},
            cache:false,        
...
$('body').on('submit', '#form-submit1', function (event) {
    ...
    if(file_size>300000) {
        ...
        $.ajax({
            url   :"{{ route('admin.beautician.upload-document') }}",
            type  :"POST",
            data  :formdata,
            cache :false,
            processData: false,
...
$('body').on('submit', '#form-submit2', function (event) {
    ...
    if (mou_sign) {
        ...
        $.ajax({
            url   :"{{ route('admin.beautician.general-info') }}",
            type  :"POST",
            data  :formdata,
            cache :false,
            processData: false,
