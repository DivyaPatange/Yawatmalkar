...
@endsection
@section('page_title', 'Edit Beautician Document')
@section('breadcrumb1', 'Home')
@section('breadcrumb2')
<a href="{{ route('admin.beautician.edit-document', $userInfo->user_id) }}">Edit Beautician Document</a>
@endsection
@section('content')
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" id="form-submit1" enctype="multipart/form-data" action="{{ route('admin.beautician.update-document', $userInfo->user_id) }}">
                @csrf
                @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
