...
class BeauticianController extends Controller
{
    ...
    public function index()
    {
        if(request()->ajax()) 
        {
            $data = DB::table('users')->where('is_register', 'Yes')->where('acc_type', 'beautician')
            ...
            ->addColumn('status', 'admin.beautician.status')
            ->addColumn('action', 'admin.beautician.action')
    ...
    public function create()
    {
        ...
        return view('admin.beautician.create', compact('category'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(empty($duplicate)){
            ...
            $userRole = Role::where('acc_type', 'beautician')->first();
    ...
    public function show($id)
    {
        ...
        return view('admin.beautician.show', compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.beautician.edit', compact('user', 'category', 'userInfo', 'subCategory'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/beautician')->with('success', 'Record Updated Successfylly!');
    }
    ...
    {
        $user  = UserInfo::where('user_id', $request->beauty_id)->first();
        if(!empty($user)){
            ...
            $result = UserInfo::where('user_id', $request->beauty_id)->update(['photo' => $image_name, 'signature' => $image_name1]);
        }
        ...
        if((count($certificate_name) > 0) && $request->hasfile('pdf_file')){
            for($i=0; $i < count($certificate_name); $i++)
            {
                if(($certificate_name[$i] != "") && ($files[$i] != "")){
                    ...
                    $userCerti->user_id = $request->beauty_id;
        ...
        return response()->json(['success' => 'Record Saved Successfully!', 'id' => $request->beauty_id]);
        // return $files;
    }

    public function saveGeneralInfo(Request $request)
    {
        $userInfo = UserInfo::where('user_id', $request->beauty_id)->first();
        ...
        User::where('id', $request->beauty_id)->update(['is_register' => 'Yes']);
    ...
    public function status(Request $request, $id)
    {
        ...
        return response()->json(['success' => 'Beautician Status Changed Successfully!']);
    }
    ...
    public function editDocument($id)
    {
        ...
        return view('admin.beautician.edit-document', compact('userInfo', 'certificates'));
    }
    ...
    public function updateDocument(Request $request, $id)
    {
        ...
        UserInfo::whereId($userInfo->id)->update($input_data);
        return redirect('/admin/beautician')->with('success', 'Documents Updated Successfully!');
    }
}
