...
class DoctorScheduleController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = DB::table('users')
            ...
            ->where('users.is_register', 'Yes')->where('users.acc_type', 'doctor')->where('users.status', 1)
        ...
        return view('admin.doctorSchedule.index', compact('users'));
    }
    ...
    {
        $users = User::where('acc_type', 'doctor')->where('is_register', 'Yes')->where('status', 1)->get();
        return view('admin.doctorSchedule.creates', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $schedule->save();
        return redirect('/admin/doctor-schedule')->with('success', 'Schedule Created Successfully!');
    }
