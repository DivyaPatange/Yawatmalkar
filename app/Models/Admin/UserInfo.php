...
class UserInfo extends Model
{
    ...
    'other_profession', 'dob', 'expectation', 'achievements', 'about_urself', 'photo', 'signature', 'license', 'bank_passbook', 'agreement', 'joining_date', 'declaration_signed', 'mou_signed', 'youtube_link'];
}
